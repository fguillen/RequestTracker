...
set :application, "requests_tracker"
set :scm, :git
set :repository,  "git@github.com:fguillen/RequestsTracker.git"
set :branch, "master"
set :deploy_to, "/home/www/requests_tracker.fernandoguillen.info"
set :user, "fguillen"
set :group, "fguillen"
set :use_sudo, false

server "requests_tracker.fernandoguillen.info", :web, :app, :db, :primary => true
